    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
          <div style={{ width: 36, height: 36, borderRadius: "50%", background: "linear-gradient(145deg,#4A7C59,#3A6347)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <span style={{ color: "#fff", fontSize: 18, fontWeight: 900 }}>P</span>
          </div>
          <div>
            <div style={{ fontSize: 22, fontWeight: 900, color: "#1A1D1A" }}>Pulse NYC</div>
            <div style={{ fontSize: 11, color: "#5C635C" }}>Public Health Dashboard</div>
          </div>
          <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 4, background: "rgba(74,124,89,0.1)", border: "1px solid rgba(74,124,89,0.2)", borderRadius: 100, padding: "3px 10px" }}>
            <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#4A7C59" }} />
            <span style={{ fontSize: 10, fontWeight: 700, color: "#4A7C59", letterSpacing: 1 }}>LIVE</span>
          </div>
        </div>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 12 }}>
          {[
            { label: "AIR QUALITY", value: "6.66", sub: "μg/m³ PM2.5", color: "#6B9E7A" },
            { label: "COVID HOSP", value: "1,763", sub: "90-day total", color: "#5b9cf5" },
          ].map(({ label, value, sub, color }) => (
            <div key={label} style={{ flex: 1, background: "#fff", border: "1px solid #E8E4DE", borderRadius: 12, padding: "12px 14px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 16 }}>
          {[
            ...
            <div key={name} style={{ background: "rgba(0,0,0,0.04)", border: "1px solid #E8E4DE", borderRadius: 8, padding: "4px 10px", display: "flex", alignItems: "center", gap: 5 }}>
              ...
              <span style={{ fontSize: 10, fontWeight: 600, color: "#1A1D1A" }}>{name}</span>
            </div>
          ))}
        </div>

        {/* Chart area placeholder */}
        <div style={{ background: "#fff", border: "1px solid #E8E4DE", borderRadius: 12, padding: "14px 16px", flex: 1 }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: "#1A1D1A", marginBottom: 12 }}>COVID-19 Trend — 12 months</div>
