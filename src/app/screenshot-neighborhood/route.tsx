    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
          <div style={{ fontSize: 11, color: "#5C635C" }}>← Neighborhoods</div>
        ...
        {/* Neighborhood name */}
        <div style={{ fontSize: 28, fontWeight: 900, color: "#1A1D1A", lineHeight: 1.1, marginBottom: 4 }}>
          Hunts Point &
        </div>
        <div style={{ fontSize: 28, fontWeight: 900, color: "#1A1D1A", lineHeight: 1.1, marginBottom: 4 }}>
          Mott Haven
        </div>
        <div style={{ fontSize: 11, color: "#5C635C", marginBottom: 20 }}>
          Pop. 194,789 · UHF42 Public Health District
        </div>

        {/* Health snapshot */}
        <div style={{ background: "#fff", border: "1px solid #E8E4DE", borderRadius: 14, padding: "16px", marginBottom: 12 }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: "#1A1D1A", marginBottom: 14 }}>Health Snapshot</div>
          {[
            { label: "Life Expectancy", value: "77.7 yrs", pct: 68, color: "#6B9E7A" },
            ...
            <div key={label} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
              <span style={{ fontSize: 10, color: "#5C635C", width: 80 }}>{label}</span>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 12 }}>
          {[
            ...
            <div key={label} style={{ flex: 1, background: "#fff", border: "1px solid #E8E4DE", borderRadius: 12, padding: "10px 12px", position: "relative", overflow: "hidden" }}>
        ...
        {/* Context card */}
        <div style={{ background: "#fff", border: "1px solid #E8E4DE", borderRadius: 12, padding: "12px 14px" }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: "#1A1D1A", marginBottom: 6 }}>Why This Matters</div>
          <div style={{ fontSize: 9, color: "#5C635C", lineHeight: 1.5 }}>
