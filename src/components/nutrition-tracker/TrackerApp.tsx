...
export default function TrackerApp() {
  ...
  return (
    <>
      {/* Settings row — the page heading is server-rendered in page.tsx so crawlers see real content */}
      <div className="mb-6">
        <div className="flex items-center justify-end -mt-12 sm:-mt-14 mb-1">
          <button
