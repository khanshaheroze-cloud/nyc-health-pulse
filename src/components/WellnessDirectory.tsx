...
const CATEGORIES: WellnessCategory[] = [
  ...
  },
  {
    ...
    spots: [
      { name: "Zeel (On-demand)", neighborhood: "Citywide", borough: "All boroughs", priceRange: "$130-180", note: "Licensed therapist comes to your home. Book same-day via app. Deep tissue, Swedish, prenatal." },
      { name: "Squeeze Massage", neighborhood: "Flatiron / Midtown", borough: "Manhattan", priceRange: "$70-120", note: "Fixed pricing, no tipping expected. Walk-ins welcome. Multiple Manhattan locations." },
      { name: "Chinatown Foot Reflexology", neighborhood: "Chinatown", borough: "Manhattan", priceRange: "$40-60/hr", note: "Traditional foot reflexology and body massage at the lowest prices in NYC. Cash only at most." },
      { name: "Body by Brooklyn", neighborhood: "Park Slope", borough: "Brooklyn", priceRange: "$100-140", note: "Sports massage and deep tissue specialists. Popular with runners and athletes." },
      { name: "Exhale Spa", neighborhood: "Multiple locations", borough: "Manhattan", priceRange: "$120-175", note: "Upscale spa with fusion massage, hot stone, and CBD-infused treatments." },
      { name: "Haven Spa", neighborhood: "Soho", borough: "Manhattan", priceRange: "$95-150", note: "Boutique day spa. Swedish, deep tissue, hot stone. Couples rooms available." },
      { name: "88 Massage", neighborhood: "Flushing", borough: "Queens", priceRange: "$45-70/hr", note: "Chinese therapeutic massage. Tui na, cupping, and acupressure. Affordable." },
      { name: "Allure Day Spa", neighborhood: "Park Slope", borough: "Brooklyn", priceRange: "$80-130", note: "Neighborhood spa with loyal following. Prenatal massage specialty." },
      { name: "Sojo Spa Club", neighborhood: "Edgewater", borough: "NJ (20 min from NYC)", priceRange: "$85-150", note: "Massage add-on to all-day thermal circuit. Indoor/outdoor pools included." },
      { name: "PRESS Modern Massage", neighborhood: "Williamsburg / UES", borough: "Manhattan/Brooklyn", priceRange: "$85-130", note: "Science-based approach. Focus on chronic pain, recovery, and injury prevention." },
    ],
  },
  {
    id: "acupuncture",
